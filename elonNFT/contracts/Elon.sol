...
contract ElonNFT is ERC721URIStorage {
    ...
    function mintNFT() public returns (uint256) {
        ...
        _setTokenURI(newItemId, "https://moccasin-peaceful-gerbil-289.mypinata.cloud/ipfs/Qmc8xVgC6eR3fDCGAzxLQhXUzyWwevJefgXpkNQG5mTHVy?_gl=1*1akr22*_ga*MTAyODQxMjM4My4xNzAyMTg2MTY3*_ga_5RMPXG14TE*MTcwMjE4NjE2Ny4xLjEuMTcwMjE4NjUyOS4zNS4wLjA.");
        console.log(
